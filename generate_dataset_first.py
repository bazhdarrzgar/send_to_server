...
NUM_RUNS   = 1  # Number of generations per text file

# llama-cpp-python server address (First Instance: Port 8011)
client = AsyncOpenAI(
...
# Even if server is sequential, this allows queueing and overlapping file I/O
...
async def main():
    if not os.path.exists(DATA_DIR):
        ...
        return
    print(f"🚀 Starting Optimized Dataset Generation (Instance 1)")
