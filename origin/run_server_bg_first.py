...
SERVER_SCRIPT = BASE_DIR / "start_llamacpp_server_first.sh"
SERVER_LOG = BASE_DIR / "llamacpp_server_logs_first.txt"
...
def main():
    ...
    # --- Robust Cleanup ---
    print("[*] Forcefully cleaning up port 8011 and old server processes...")
    os.system("fuser -k 8011/tcp > /dev/null 2>&1 || true")
