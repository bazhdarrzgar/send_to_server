#!/usr/bin/env python3
"""
generate_dataset_third.py (Optimized Async Version) - Third Dataset Instance
"""
...
# llama-cpp-python server address (Third Instance: Port 8010)
client = AsyncOpenAI(
...
async def main():
    if not os.path.exists(DATA_DIR):
        ...
        return
    print(f"🚀 Starting Optimized Dataset Generation (Instance 3)")
