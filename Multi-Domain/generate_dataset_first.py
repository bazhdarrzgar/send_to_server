...
BASE_DATA_DIR   = "../SKNAD_Split_Only"
BASE_OUTPUT_DIR = "../SKNAD_Split_Only_Output"

# Specific subfolders for the FIRST script (GPU 0)
TARGET_FOLDERS = [
    "part2/Kurdistan24_141098",
    "part2/NRT_All_68079",
    "part3/Sharpress_37084",
    "part3/Rachlaken_23961",
    "part3/Xelk_160"
]
...
def main():
    print(f"🚀 Starting dataset generation for (FIRST Script - GPU 0)")
